...
public class spellbook {
    public class wizard {
        spell[] spells = new spell[] {
            ...
            new spell('d', 6, 'e', 3, "Lightning Bolt", "A intermediate electricity spell. Great against creatures of fire"),
            new spell('d', 6, 'i', 3, "Ice Blast", "A intermediate ice spell. Great against creatures of earth"),
            new spell('d', 6, 'P', 3, "Roots", "A intermediate earth spell. Great against creatures of electricity"),
