...
public class dungeons {
    public class roomTraps {
        ...
        /* Description is a letter and 2 numbers, first uppercase letter representing area of math,
        ...
        public static String[][] chooseProblem = {
                ...
                {"C3b", "Calculate 1/4 + 1/6. Answer as a simplified fraction in the form x/y with natural numbers", "5/12"},
                ...
                {"A2b", "5x = 4. What is the value of x as a simplified fraction in the form a/b with natural numbers", "4/5"},
                ...
                {"A4a", "The answers to a quadratic equation are (x-7)(x+7), what was the value greater than 1 in the original equation", "49"},
                ...
                {"R3b", "What shape does the graph y = xˆ2 + yˆ2 make. type your answer in lowercase letters", "circle"},
                {"R3c", "What's the area of the largest triangle that could be contained by a square of side length 4", "8"},
                {"R3d", "Does y=0 intercept y = 2|x+2| -1 \"right\" or \"left\" of the origin", "left"},
                {"R3e", "A pie has a circumference of 12, equal slices at a 60 degree angle are made from the center, what's the length of the slices' crust", "2"},
                {"R4a", "3 supplimentary angles have a ratio of 3:2:4. Find the smallest angle in degrees", "40"},
                {"R4b", "Whats the length of the largest line that can be contained in a circle with a 60 degree arc length of pi/2", "3"},
                {"R4c", "A rectangular area will be enclosed by a 40m fence, if the area is maximized what is it in meters squared", "100"},
